...
\end{itemize}
Es gibt auch Ansätze, welche beide Methoden verbindet \cite{combination}. Im weiteren Verlauf wird jedoch nur auf \nameref{sec:skeleton-extraction} und \nameref{sec:skeleton-embedding} eingegangen.
...
Für ein bessers Verständnis kann man sich auch den Artikel von R.A. Jarvis zum Thema zur Identifikation von convexen Hüllen in einem endlichen Set von Punkten \cite{convex} anschauen. Der signifikante Unterschied zwischen den beiden Methoden ist jedoch folgender. In der oben genanten Methode ist die Suche auf den Radius $r$ begrenzt.
