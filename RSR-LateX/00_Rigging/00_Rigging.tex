...
\begin{figure}[t]
	...
	\includegraphics[]{00_Rigging/Pictures/gabriel.png}
		\caption[Erklärung von Gabriel Nachbarn]{ links) $a$ und $b$ sind Gabriel Nachbarn da der Punkt $c$ nicht in dem Kreis mit dem Radius $\overline{ab}$ liegt. rechts) Die Punkte $a$ und $b$ sind keine Gabriel Nachbarn, da $c$ im aufgespannten Kreis liegt. Entnommen von \url{https://en.wikipedia.org/wiki/Gabriel_graph}}
		\label{gabriel}
\end{figure}
...
\end{itemize}
Für jede dieser Möglichkeiten wurde eine Funktion $f$ aufgestellt. Diese Funktionen wurden manuell erzeugt 
