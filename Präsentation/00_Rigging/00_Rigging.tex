...
\begin{frame}{
	...
	\begin{itemize}
		...
		\item Suchen des Punnktes mit größtem Winkel $\angle P_{1}P_{2}P_{3}$
...
\begin{frame}{
	...
	\begin{itemize}
		...
		\item Gelneke, welche im Graph na beieinander im org. Skelett weit entfernt liegen
	\end{itemize}
...
\begin{frame}{
	...
	\begin{table}
		...
		\begin{tabular}{  p{.4\linewidth} | p{.4\linewidth} }
			Skelett-Extraktion & Skelett-Einbindung \\\hline\hline
			Mess muss aus zylindrischen Teilen bestehen & Stark eingeschränkt auf gegebenes Skelett \\\hline
...
\begin{frame}{
	...
	\begin{table}
		...
		\begin{tabular}{  p{.4\linewidth} | p{.4\linewidth} }
			...
			Pose und Überdeckung sind wichtige & Beide Füße müssen auf dem Boden stehen \\\hline
			Kriterien für Findung der Mittelachsen und Gelenke &
		\end{tabular}
	\end{table}
