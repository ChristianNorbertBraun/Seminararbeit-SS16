...
\begin{frame}{\Huge{Ungeeignete Einbettungsmöglichkeiten}}
...
\begin{frame}{\Huge{Allgemeingültigkeit}}
...
\begin{frame}{\Huge{Selbstständigkeit}}
	
	\begin{table}
		\centering
		\begin{tabular}{  p{.4\linewidth} | p{.4\linewidth} }
			Skelett-Extraktion & Skelett-Einbindung \\\hline\hline
			Einschränkung durch vorgegebenes Mesh & Pose und gegebenes Skelett müssen sich ähneln \\\hline
