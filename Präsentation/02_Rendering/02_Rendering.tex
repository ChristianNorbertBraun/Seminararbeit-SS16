...
\pdfnote{3D Model wird benötigt. Entweder Automatisch oder manuell}
\begin{frame}{\Huge{Materialbasiertes Model der lokalen Szene}}
	...
	\begin{itemize}
		\item Empfängt Schatten und Reflexion von synthetischen Model
...
\begin{frame}{\Huge{Sonderfälle}}
	...
	\begin{itemize}
		...
		\item Spekulare Oberflächen der Distanzszene können vom Model beeinflusst werden
...
\pdfnote{Lichtbasiertes Model der Distanzszene}
...
\end{frame}
\pdfnote{3d Model der Lichtsonde in Box}
...
\pdfnote{Lichtbasiertes model}
\pdfnote{Materialbasiertes Model}
...
\begin{frame}{\Huge{Ergebnis}}
	...
	\begin{itemize}
		...
		\item Strahlen vom Model über die lokale Szene bis in die Distanzszene verfolgen
	\end{itemize}
		\blfootnote{Bildquellen: \cite{realImages}} 
\end{frame}
...
\begin{frame}{\Huge{Einfügen des synthetischen Models}}
		\begin{figure}
			\centering
			\begin{minipage}{.4\paperwidth}
				\centering
...
\pdfnote{Lichtbasiertes Model oder Panorame}
